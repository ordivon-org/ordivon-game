...
audience:
  ...
  - agent
updated: 2026-08-17
summary: Decision separating registered Station Zero execution, canonical G0-G8 product lifecycle authority, Game Core treatments, the R1–R17 foundations corpus, v3 reference evidence, exact P0-P3 contracts, long-range Game vision, and machine truth.

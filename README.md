...
- [`docs/GAME_PRE_G0_DIRECTION_SEARCH.md`](docs/GAME_PRE_G0_DIRECTION_SEARCH.md) is the canonical Pre-G0 direction-search surface: it opens a broad GameForm candidate basis, separates Agent necessity from Agent availability, tracks production burden, and assigns cheapest falsifiers without selecting a product.

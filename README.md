...
audience:
  ...
  - agent
updated: 2026-08-17
summary: Canonical entry to Ordivon Game, its cross-game development model, current Station Zero executable, research treatments, and the R1–R19 foundations corpus without selecting a new product.
...
- [`docs/GAME_FOUNDATIONS_RESEARCH_MAP.md`](docs/GAME_FOUNDATIONS_RESEARCH_MAP.md) is the compact conceptual map for the R1–R19 foundations corpus and its cross-domain abstractions.
- [`docs/GAME_FOUNDATIONS_CONTINUATION.md`](docs/GAME_FOUNDATIONS_CONTINUATION.md) is the context-switch handoff; after R19 the next frontier is R20 Creation / Creativity / Expression / Authorship / Construction / Customization / Style.
